...
@Component({
  ...
  templateUrl: './control-before-confirmation.component.html',
  styleUrls: ['./control-before-confirmation.component.css']
})
export class ControlBeforeConfirmationComponent implements OnInit, OnDestroy{
  ...
  constructor(
    public dialogRef: MatDialogRef<ControlBeforeConfirmationComponent>,
